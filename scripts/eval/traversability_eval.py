...
trade-off curve (assessed fraction vs false-safe rate).
    ...
    python tools/traversability_eval.py --limit 250 --tau 1.0
    python tools/traversability_eval.py --tau_sweep
...
def main():
    ...
    with open(OUT / 'table_traversability_sweep.tex', 'w') as f:
        f.write('% Auto-generated by tools/traversability_eval.py --tau_sweep\n')
